...
class TestMassMailing(HttpCase):
    def test_snippet_newsletter_popup_mass_mailing(self):
        self.start_tour(
            "/", "snippet_newsletter_popup_edition_double_opt", login="admin"
        )
        self.start_tour("/", "snippet_newsletter_popup_use_double_opt", login=None)
    ...
    def test_snippet_newsletter_block_witih_edit_mass_mailing(self):
        ...
        self.start_tour(
            ...
            "snippet_newsletter_block_with_edit_double_opt",
            login="admin",
        )
