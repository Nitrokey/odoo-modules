...
export class Composer extends Component {
    ...
    get composerView() {
        return (
            this.messaging &&
            this.messaging.models["mail.composer_view"].get(
                this.props.composerViewLocalId
            )
        );
    }
    ...
    get hasHeader() {
        ...
        return (
            ...
            (this.composerView.threadView &&
                this.composerView.threadView.replyingToMessageView)
        );
    }
    ...
    _postMessage() {
        ...
        if (
            ...
            this.composerView.composer.thread.__values.fetchMessagesParams
                .thread_model &&
