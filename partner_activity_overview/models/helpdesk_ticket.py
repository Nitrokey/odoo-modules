...
class HelpdeskTicket(models.Model):
    ...
    def message_post(self, body='', subject=None,
        ...
        msg = super(HelpdeskTicket, self).message_post(body=body, subject=subject, message_type=message_type,
    ...
    def _message_log(self, body='', subject=False, message_type='notification', **kwargs):
        msg = super(HelpdeskTicket, self)._message_log(body='', subject=False, message_type='notification', **kwargs)
        if not self.partner_id:
            return msg
        part_msg_body = msg.body
