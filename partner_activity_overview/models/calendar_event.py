...
class CalendarEvent(models.Model):
    ...
    def message_post(self, body='', subject=None,
        ...
        msg = super(CalendarEvent, self).message_post(body=body, subject=subject, message_type=message_type,
        ...
        for partner in self.partner_ids:
            partner_msg = msg.copy(default={'res_id': partner.id, 'model': 'res.partner', 'body': part_msg_body})
            flag = False
    ...
    def _message_log(self, body='', subject=False, message_type='notification', **kwargs):
        msg = super(CalendarEvent, self)._message_log(body='', subject=False, message_type='notification', **kwargs)
        part_msg_body = msg.body
        for partner in self.partner_ids:
            partner_msg = msg.copy(default={'res_id': partner.id, 'model': 'res.partner', 'body': part_msg_body})
            flag = False
