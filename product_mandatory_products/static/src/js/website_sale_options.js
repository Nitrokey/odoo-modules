    ...
    _onModalSubmit: function (goToShop) {
        ...
        this.optionalProductsModal.getAndCreateSelectedProducts()
            .then((products) => {
                ...
                ajax.post('/shop/cart/update_option', {product_and_options: productAndOptions, goto_shop: goToShop})
...
//       Get all product inside cart and send to controller to check for mandatory product.
    _onConfirmButtonClick: function() {
        ...
        rpc.query({
            ...
            params: {products: products, root_product: this.rootProduct.product_id, current_context: this.context}
        })
        .then(function (res) {
